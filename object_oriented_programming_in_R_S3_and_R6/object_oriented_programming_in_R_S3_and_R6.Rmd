...
The data stored by an R6 object is deliberately hidden away from teh user by keeping it in the *private* element. This is the principle of *encapsulation*. 
...
Active bindings can also be used to set private fields. In this case, the binding functions shoudl accept a single argument, names "value". 
